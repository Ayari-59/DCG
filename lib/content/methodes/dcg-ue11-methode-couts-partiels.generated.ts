...
export const methodes: Methode[] = [
  {
    ...
    "blocks": [
      {
        "type": "p",
        "text": "*Selon le contexte de l’organisation et les objectifs de la situation de gestion, il faut choisir le coût partiel le plus adapté ; La question à se poser est : pour une situation, un problème de gestion, quelle est la partie des charges qu’il est pertinent d’intégrer dans le coût calculé :*"
      },
      {
        "type": "ul",
        "items": [
